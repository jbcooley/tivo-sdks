...
namespace Tivo.Has.HostSideAdapters
{
    ...
    public class IHmeConnectionViewToContractHostAdapter : System.AddIn.Pipeline.ContractBase, Tivo.Has.Contracts.IHmeConnectionContract
    {
        private Tivo.Has.IHmeConnection _view;
        public IHmeConnectionViewToContractHostAdapter(Tivo.Has.IHmeConnection view)
        {
            _view = view;
        }
